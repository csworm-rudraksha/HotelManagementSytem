...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        b1.setOpaque(true);  // Makes the background color visible
        b1.setBorderPainted(false);  // Optionally remove border to match style
        add(b1);
        ...
        b2.setOpaque(true);  // Makes the background color visible
        b2.setBorderPainted(false);  // Optionally remove border to match style
        add(b2);
